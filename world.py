...
class World:
    ...
    @staticmethod
    def make_planets(region, rand_size, rand_coords, world_type):
        for n in range(len(rand_coords)):
            inner, outer = World.sphere(rand_size[n])
            inner_block, outer_block, soil_planet = World.choose_planet_type(world_type)
    ...
    @staticmethod
    def choose_planet_type(world_type):
        outer_block = ""
        inner_block = ""
